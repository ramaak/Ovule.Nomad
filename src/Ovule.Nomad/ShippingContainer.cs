...
namespace Ovule.Nomad
{
  ...
  [Serializable]
  public class ShippingContainer<T> : IShippingContainer<T>, IShippingContainer
  {
    /// <summary>
    ...
    /// </summary>
    public T Cargo { get; private set; }

    object IShippingContainer.Cargo { get { return Cargo; } }

    public ShippingContainer(Uri destination, T cargo)
    {
      this.ThrowIfArgumentIsNull(() => destination);
